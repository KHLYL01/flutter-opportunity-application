...
class ViewUserProfilePage extends StatelessWidget {
  const ViewUserProfilePage({super.key});
  @override
  Widget build(BuildContext context) {
    // UserProfileModel userProfileModel = Get.arguments[0];
          ...
          body: ListView(
            children: [
              ...
              CustomOutlineButton(
                width: context.width,
                text: 'Resume',
                icon: controller.userProfile.pdfUrl == null
                    ? Icons.warning_amber
                    : Icons.attach_file_outlined,
                padding: 0,
                onPressed: controller.userProfile.pdfUrl == null
                    ? null
                    : () {
